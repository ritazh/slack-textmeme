    ...
    return this.getAvailableMemes()
      .then((availableMemes) => {
        ...
        if (topText === undefined || topText === null || bottomText === undefined || bottomText === null) {
          cb('Hmmm...seems you forgot to provide the top and bottom text for your meme. Try again! Example usage: /textmeme doge; This BOT is; AWESOME;')
        }
        ...
        if (memeRequestUrl) {
          ...
          cb(`Hmmm...seems we cannot find the meme ${name}. Try another meme!`)
        }
      })
  }
}
