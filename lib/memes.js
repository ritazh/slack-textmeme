    ...
    return this.getAvailableMemes()
      .then((availableMemes) => {
        ...
        if (topText === undefined || topText === null || bottomText === undefined || bottomText === null) {
          cb('Hmmm...seems you forgot to provide the top and bottom text for your meme. Try again! Example usage: doge; This BOT is; AWESOME;', null)
        }
        ...
        if (memeRequestUrl) {
          ...
          return fetch(memeRequestUrl)
            ...
            .then((meme) => {
              ...
              cb(`${topText} ${bottomText}`, memeLink)
            })
        } else {
          // We didn't find a meme, let's respond with an error
          cb('Hmmm...seems we cannot find the meme ${name}. Try another meme!', null)
        }
      })
  }
}
